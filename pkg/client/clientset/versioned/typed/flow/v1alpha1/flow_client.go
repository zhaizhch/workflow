...
// FlowV1alpha1Client is used to interact with features provided by the flow.workflow.sh group.
type FlowV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FlowV1alpha1Client) WorkTemplates(namespace string) WorkTemplateInterface {
	return newWorkTemplates(c, namespace)
}

func (c *FlowV1alpha1Client) Workflows(namespace string) WorkflowInterface {
...
// NewForConfigAndClient creates a new FlowV1alpha1Client for the given config and http client.
